...
class ParkingLotsControllerTest < ActionController::TestCase
  ...
  test "should create parking_lot" do
    assert_difference('ParkingLot.count') do
      post :create, parking_lot: { address: @parking_lot.address, author_id: @parking_lot.author_id, details: @parking_lot.details, latitude: @parking_lot.latitude, longitude: @parking_lot.longitude, name: @parking_lot.name, paid: @parking_lot.paid }
    end
  ...
  test "should update parking_lot" do
    put :update, id: @parking_lot, parking_lot: { address: @parking_lot.address, author_id: @parking_lot.author_id, details: @parking_lot.details, latitude: @parking_lot.latitude, longitude: @parking_lot.longitude, name: @parking_lot.name, paid: @parking_lot.paid }
    assert_redirected_to parking_lot_path(assigns(:parking_lot))
  end
